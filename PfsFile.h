...
private:
   ...
   int decrypt_icv_file(fs::path destination_root) const;

   int decrypt_unicv_file(fs::path destination_root) const;

public:
   int decrypt_file(fs::path destination_root) const;
};
